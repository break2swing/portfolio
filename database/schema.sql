/*
  ...
  3. Stockage
    - Créer manuellement un bucket `photo-files` dans Supabase Storage
    - Configuration : Public = true pour permettre l'accès aux URLs
    - Types de fichiers acceptés : image/jpeg, image/png, image/webp, image/gif
    - Taille maximale : 5MB

  4. Notes importantes
    - L'utilisateur admin doit être créé manuellement dans Supabase Auth
    - Les URLs des images seront du format : {SUPABASE_URL}/storage/v1/object/public/photo-files/{filename}
*/
